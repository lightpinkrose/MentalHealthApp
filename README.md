...
The app focuses on promoting self-awareness and encouraging healthier habits — without overwhelming users with complex features or subscription barriers. It is not intended to diagnose or treat mental health conditions, but rather to serve as a personal tracking tool that users can reference when speaking with healthcare providers.
...
Secure login validation using SQLite
...
Stress level tracking using SeekBar
...
Secure user authentication design

Navigation handling

Git version control & tagging

Debugging Gradle and dependency conflicts
...
Secure credential verification via SQLite queries

Separation of concerns between activities and database helper
...
Login/Register Activity – Secure user authentication

Home Activity – Dashboard with navigation options
...
Iterative weekly improvements

Continuous instructor feedback implementation
